...
class SaccountClassRequest extends BaseRequest {

    protected $entite = "SaccountClass"; //Nom de l'objet, pour les percomptes par exemple
    protected $nom_param_route = "saccountclass"; //request route parameter
    protected $nom_table_suffixe = "saccountclasses"; //le nom de la table sans prefixe
