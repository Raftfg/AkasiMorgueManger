...
class ParametreController extends ComptabiliteController {
     ...
     * @var PostRepository
     */
    protected $parametreRepositoryEloquent, $corpsRepositoryEloquent, $mouvementRepositoryEloquent, $userRepositoryEloquent;

    public function __construct(ParametreRepositoryEloquent $parametreRepositoryEloquent, CorpsRepositoryEloquent $corpsRepositoryEloquent, MouvementRepositoryEloquent $mouvementRepositoryEloquent, UserRepositoryEloquent $userRepositoryEloquent) 
    {
        parent::__construct();
